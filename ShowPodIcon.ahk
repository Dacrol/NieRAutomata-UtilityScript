; Script for showing pod icon on screen
; Based on gdi+ ahk tutorial 3 written by tic (Tariq Porter)
...
;#Include C:\Users\Dacrol\Downloads\Gdip_All.ahk
...
If !pBitmap
{
	MsgBox, 48, File loading error!, Could not load 'img/podicon.png'
	ExitApp
}
